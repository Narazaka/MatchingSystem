...
namespace Narazaka.VRChat.MatchingSystem
{
    ...
    public class MatchingPlayerRoom : CyanPlayerObjectPoolObject
    {
        ...
        [UdonSynced] internal bool Remaining;
        ...
        /// by manager (owner)
        /// </summary>
        internal void SetRoom(sbyte roomAndSpawnPoint)
        {
        ...
        /// by manager (owner)
        /// </summary>
        internal void SetMatch(uint matchedPlayerHash, bool matched)
        {
            Matched = matched;
        ...
        /// call last
        /// </summary>
        internal void SetJoiningSessionId(short sessionId)
        {
        ...
        void TryAddMatchedPlayerHash()
        {
            if (prevMatched != Matched || prevMatchedPlayerHash != MatchedPlayerHash)
            {
                ...
                if (Matched && Owner != null && Owner.isLocal) MatchingPlayer.AddMatchedPlayerHash(MatchedPlayerHash);
            }
        }
